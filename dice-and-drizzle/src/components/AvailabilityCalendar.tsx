...
export default function AvailabilityCalendar({
  ...
  return (
    <div className="availability-calendar">
      ...
      <div className="availability-day-strip" role="group" aria-label="Choose your session time">
        {days.map((d) => {
      ...
      {status === "searching" && <p className="availability-loading">Looking for the next available time…</p>}
      {status === "error" && (
        <>
