...
export default function CartView() {
  ...
  if (loading) {
    return <p className="cart-empty">Setting the table…</p>;
  }
  ...
  if (items.length === 0) {
    return (
      <div className="cart-empty">
        ...
        <a href="/products" className="checkout-btn">Browse the shop</a>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_22rem] gap-12 md:gap-16 md:items-start">
          ...
          return (
            ...
            >
              ...
              <div className="cart-item-info">
                <h3 className="cart-item-name font-display text-lg leading-tight">
                  {(() => {
                    const productHref = !unavailable ? resolveProductHref(item) : undefined;
                    return productHref ? (
      ...
      <div className="cart-summary">
        ...
        >
          {checkingOut ? "Taking you to checkout…" : "Proceed to checkout"}
        </button>
      </div>
    </div>
  );
